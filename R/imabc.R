...
#' * RunMetadata_tag.csv              = current_iteration, last_draw
#'
...
#' * current_iteration - the last iteration that completed
#' * last_draw - the total number of draws simulated during execution
#'
#' if validate_run = TRUE, includes:
