eval_targets <- function(sim_targets, target_list, criteria = c("start", "update", "stop"), use_met_targets = TRUE) {
  ...
  distances <- target_distance(dt = sim_targets, target_list = target_list, use_met_targets = use_met_targets)
