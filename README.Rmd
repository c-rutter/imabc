...
<!-- badges: start -->
[![Build & R-CMD Check](https://github.com/carolyner/imabc/workflows/R-CMD-check/badge.svg)](https://github.com/carolyner/imabc/actions)
<!-- badges: end -->
...
priors <- define_priors(
  ...
  add_prior(
    parameter_name = "x2",
    density_fn = "dunif"#,
    # mean = 0.5, sd = 0.1, a = 0.4, b = 0.9, # a = min and b = max
    # min = 0.4, max = 0.9 # User must specify both in truncnorm
  ),
...
targets <- define_targets(
  ...
  G1 = group_targets(
    T1 = add_target(
      target = 1.5, scale = 0.1,
      starting_range = c(0, 3),
      stopping_range = c(1.45, 1.55)
    ),
    add_target(
      target_name = "T2",
      target = 0.5, scale = 0.1,
      starting_range = c(0, 1),
